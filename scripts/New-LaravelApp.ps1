...
try {
    ...
    Write-Host "Creating a new Laravel project: $ProjectName..."
    ...
    # The .gitignore file is created by Laravel

    Write-Host "Successfully created a new Laravel project: $ProjectName"
}
catch {
