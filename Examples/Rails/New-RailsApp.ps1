...
try {
    ...
    Write-Host "Creating a new Rails project: $ProjectName..."
    ...
    # The .gitignore file is created by Rails

    Write-Host "Successfully created a new Ruby on Rails project: $ProjectName"
}
catch {
